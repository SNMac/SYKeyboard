...
/// 한글 키보드 입력/UI 컨트롤러
final class HangeulKeyboardViewController: UIInputViewController {
    ...
    /// 키보드 전환 버튼 제스처 컨트롤러
    private lazy var switchButtonGestureController = SwitchButtonGestureController(hangeulKeyboardView: hangeulKeyboardView,
    ...
    private lazy var textInteractionButtonGestureController = TextInteractionButtonGestureController(hangeulKeyboardView: hangeulKeyboardView,
                                                                                                     englishKeyboardView: nil,
                                                                                                     symbolKeyboardView: symbolKeyboardView,
                                                                                                     numericKeyboardView: numericKeyboardView,
                                                                                                     getCurrentKeyboardLayout: { [weak self] in return self?.currentKeyboardLayout ?? .hangeul })
...
extension HangeulKeyboardViewController: SwitchButtonGestureControllerDelegate {
...
extension HangeulKeyboardViewController: TextInteractionButtonGestureControllerDelegate {
