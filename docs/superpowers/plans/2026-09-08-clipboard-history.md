...
| 앱 삭제 확인 시트가 스와이프한 행(스와이프 삭제)과 하단 바 삭제 버튼(편집 모드)에서 뜸(iOS 26+) | 확인 (2026-09-10, iOS 27 실기기) |
| iOS 16에서 편집 모드 삭제(하단 바 버튼에 붙인 `confirmationDialog`)의 확인 시트가 하단 시트로 뜸 | 확인 (2026-09-10, iPhone SE iOS 16 실기기 스크린샷: "고정 항목 1개를 삭제할까요?" 하단 시트, 삭제·취소) |
