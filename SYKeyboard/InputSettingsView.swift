...
struct InputSettingsView: View {
    ...
    @AppStorage("isHangeulTypeAfterSpaceInputEnabled", store: UserDefaults(suiteName: "group.github.com-SNMac.SYKeyboard")) private var isHangeulTypeAfterSpaceInputEnabled = true
    ...
    var body: some View {
        ...
        Toggle(isOn: $isHangeulTypeAfterSpaceInputEnabled, label: {
            Text("한글 자판 자동 변경")
