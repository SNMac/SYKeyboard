...
extension UIDevice {
    var modelName: String {
        ...
        case "Watch7,8":                return "Apple Watch Series 10 42mm case (GPS)"
        case "Watch7,9":                return "Apple Watch Series 10 46mm case (GPS)"
        case "Watch7,10":               return "Apple Watch Series 10 42mm case (GPS+Cellular)"
